...
public class JwtUtil {
    ...
    public static <T> String createJWT(T subject, Long ttlMillis) {
        String jsonString = JSON.toJSONString(subject);
        JwtBuilder builder = getJwtBuilder(jsonString, ttlMillis, getUUID());// 设置过期时间
        return builder.compact();
    }
    ...
    public static <T> T parseJWT(String jwt, Class<T> objectType) throws Exception {
        SecretKey secretKey = generalKey();
